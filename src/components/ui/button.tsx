...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-glow rounded-2xl",
        ...
        premium: "bg-gradient-primary text-primary-foreground hover:shadow-glow hover:scale-105 rounded-2xl font-semibold",
        success: "bg-success text-success-foreground hover:bg-success/90 rounded-2xl",
        danger: "bg-danger text-danger-foreground hover:bg-danger/90 rounded-2xl",
      },
      size: {
